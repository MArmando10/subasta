...
<div class="container">
    ...
    <section>
        <div class="row">
            ...
            width="200" clas s="mx-auto d-block img-fluid" style="height: auto; width:200px; transform:
            translateX(-20%)">
            @endfor
        ...
        <div class="col-3 text-center" style="transform: translateY(20%);">
            ...
            <div class="item"><img src="{{asset($product->imagenes[$i]->url)}}" alt="slider-image"
